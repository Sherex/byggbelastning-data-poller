...
module.exports = async (mse, mapHierarchies) => {
  ...
  //   // const { data: maps } = await mse.getPagination('api/contextaware/v1/maps.json')
  ...
  //   const { data } = await mse.getPagination(`lapi/contextaware/v1/ocation/history/clients.json?mapHierarchy=${mapHierarchy}`)
