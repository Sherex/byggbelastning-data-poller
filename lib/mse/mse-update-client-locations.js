...
module.exports = async (axiosInstance, mapHierarchies) => {
  ...
  // let { data: clients } = await axiosInstance.get('location/history/clients.json')
  // await dummy.save('mse-location-history', clients)
  let clients = await dummy.load('sample-data/reports/auto/mse-location-history/2020-06-16T19:47:12.873Z.json')
  ...
  clients.forEach(mseClientToLocation.push)
  console.log(maps)
  // if (!mapHierarchies) {
  ...
  //   // const { data: maps } = await axiosInstance.get('maps.json')
  //   // await dummy.save('mse-maps', maps)
  //   const maps = await dummy.load('./sample-data/reports/auto/mse-maps/2020-06-16T19:12:58.832Z.json')
  ...
  //   const { data } = await axiosInstance.get(`location/history/clients.json?mapHierarchy=${mapHierarchy}`)
