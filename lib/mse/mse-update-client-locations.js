...
module.exports = async (getMse, mapHierarchies) => {
  ...
  // let { data: clients } = await getMse('location/history/clients.json')
  ...
  //   // const { data: maps } = await getMse('maps.json')
  ...
  //   const { data } = await getMse(`location/history/clients.json?mapHierarchy=${mapHierarchy}`)
